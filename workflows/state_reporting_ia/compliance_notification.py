...
insert_batch = [("Iowa-Compliance@intoxalock.com","statedatabrickfeed@intoxalock.com","","","Iowa DataFeed",html_batch,0,\
                 "IA DataFeed do not match batch file",369, datetime.now(),"Pending",590,None,None, datetime.now(),"DatafeedUser",6254,"DatafeedUser",6254,None)]
...
insert_customer = [("Iowa-Compliance@intoxalock.com","statedatabrickfeed@intoxalock.com","","","Iowa DataFeed",html_customer,0,\
                    "IA DataFeed dont match with customer table",369,datetime.now(),"Pending",590,None,None, datetime.now(),"DatafeedUser",6254,"DatafeedUser",6254,None)]
